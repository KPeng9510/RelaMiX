...
def main():
    ...
    ref_lists=['/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/tyt_files/ref_tyt_'+str(shot)+'shot_split'+str(i)+'.txt' for i in range(12)]
    ref_path= ref_lists[ref_round]

    args.train_source_list = '/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/TranSVAE/dataset_preparation/train_sims_filelist.txt'
    args.train_target_list = ref_path
    args.val_list = '/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/tyt_files/test_tyt_list.txt'
    ...
    val_set = TSNDataSet("/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/i3d_features_test/RGB-feature_i3d/features/",
                        "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/i3d_features_test/RGB-feature_i3d/features/",
                            "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/tyt_files/test_tyt_list.txt",
    ...
    if not args.evaluate:
        source_set = TSNDataSet_Sims("/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/sims4action/features_i3d_train2/RGB-feature_i3d/",
                                "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/sims4action/features_i3d_train2/RGB-feature_i3d/",
                                "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/TranSVAE/dataset_preparation/train_sims_filelist.txt",
        ...
        target_set = TSNDataSet("/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/i3d_features_train/RGB-feature_i3d/features/",
                                "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/tyt/i3d_features_train/RGB-feature_i3d/features/",
                                ref_path,
...
def train(num_class, source_loader, target_loader, model, criterion, criterion_domain, optimizer, epoch, log, log_short, alpha, beta, gamma, mu):
    ...
    for j in range(10):
        print(len(source_feat_list[j]))	
    gms = [[GaussianMixture(n_components=1, random_state=0).fit(np.stack(source_feat_list[j])[:,i,:]) for i in range(12)] for j in range(10)]
    ...
    for j in range(num_class):
        ...
        for i in range(12):
            ...
            base_means = [gms[k][i].means_[0] for k in range(10)]
            base_convs = [gms[k][i].covariances_[0] for k in range(10)]
            num_sampled = 200
    ...
    f = open('generated_new_data_sims2tyt_shot20.pkl', 'wb')
