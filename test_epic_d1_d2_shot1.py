...
def main():
    ...
    checkpoint = torch.load('/hkfs/work/workspace_haic/scratch/fy2374-workspace/hiwi_workspace/ZDDA/RelaMiX/verify_docs/epic_d1_to_d2_shot1/RGB/model_best.pth.tar')
