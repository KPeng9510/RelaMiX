...
parser.add_argument('--num_segments', type=int, default=12) # 12
parser.add_argument('--val_segments', type=int, default=12)
...
parser.add_argument('--frame_aggregation', type=str, default='tranrd',
                    choices=['avgpool', 'rnn', 'temconv', 'trn', 'tranrd', 'none'], help='aggregation of frame features (none if baseline_type is not video)')
...
parser.add_argument('--dropout_v', '--dov', default=0.8, type=float,
                    metavar='DOV', help='dropout ratio for video-level feature (default: 0.5)') # 0.1
parser.add_argument('--loss_type', type=str, default="nll",
                    choices=['nll'])
parser.add_argument('--weighted_class_loss', type=str, default='N', choices=['Y', 'N'])

#------ RNN ------
parser.add_argument('--n_rnn', default=2, type=int, metavar='M',
                    help='number of RNN layers (e.g. 0, 1, 2, ...)')
parser.add_argument('--rnn_cell', type=str, default='GRU', choices=['LSTM', 'GRU'])
parser.add_argument('--n_directions', type=int, default=2, choices=[1, 2],
...
parser.add_argument('--weighted_class_loss_DA', type=str, default='N', choices=['N', 'N'])
parser.add_argument('--place_dis', default=['N', 'N', 'N'], type=str, nargs="+",
                    metavar='N', help='where to place the discrepancy loss (length = add_fc + 2)')
parser.add_argument('--place_adv', default=['N', 'N', 'N'], type=str, nargs="+",
...
parser.add_argument('-b', '--batch_size', default=[32, 24, 64], type=int, nargs="+",
...
parser.add_argument('--clip_gradient', '--gd', default=30, type=float,
...
<<<<<<< HEAD
parser.add_argument('--exp_path', type=str, default="/hkfs/work/workspace_haic/scratch/fy2374-workspace/hiwi_workspace/ZDDA/RelaMiX/checkpoints_test/", 
=======
parser.add_argument('--exp_path', type=str, default="/path/to/your/folder/for/checkpoints/", 
>>>>>>> origin/master
