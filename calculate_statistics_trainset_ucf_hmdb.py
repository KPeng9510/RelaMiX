...
def main():
    ...
    ref_lists=['/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/DANN/dataset/new_ucfhmdb/ref_ucf2hmdb_'+str(shot)+'shot_split'+str(i)+'.txt' for i in range(12)]
    ref_path= ref_lists[ref_round]

    args.train_source_list = '/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/TranSVAE/dataset/ucf101/list/I3Dpretrain/list_train_ucf101-hmdb51_I3Dpretrain.txt'
    args.train_target_list = ref_path
    args.val_list = '/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/TranSVAE/dataset/hmdb51/list/I3Dpretrain/list_val_ucf101-hmdb51_I3Dpretrain.txt'
    ...
    val_set = TSNDataSet("/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/hmdb_ZDDA/hmdb_rgb/RGB-feature_i3d/",
                        "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/hmdb_ZDDA/hmdb_rgb/RGB-feature_i3d/",
                            "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/TranSVAE/dataset/hmdb51/list/I3Dpretrain/list_val_ucf101-hmdb51_I3Dpretrain.txt",
    ...
    if not args.evaluate:
        source_set = TSNDataSet("/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ucf-101_features_new/",
                                "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ucf-101_features_new/",
                                "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/ZDDA/TranSVAE/dataset/ucf101/list/I3Dpretrain/list_train_ucf101-hmdb51_I3Dpretrain.txt",
        ...
        target_set = TSNDataSet("/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/hmdb_ZDDA/hmdb_rgb/RGB-feature_i3d/",
                                "/pfs/work7/workspace/scratch/fy2374-train/acmmm_and_aaai/hmdb_ZDDA/hmdb_rgb/RGB-feature_i3d/",
                                ref_path,
...
def train(num_class, source_loader, target_loader, model, criterion, criterion_domain, optimizer, epoch, log, log_short, alpha, beta, gamma, mu):
	...
	f = open('generated_new_data_hmdb_ucf_shot1.pkl', 'wb')
